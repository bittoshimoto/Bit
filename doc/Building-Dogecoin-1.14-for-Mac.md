### This process has not be completed for Bit.

This is the process for Dogecoin. We do not have a repo similar to https://github.com/michilumin/dogecoin.git for Bit. We did not have the need to test this process as none of us develop on Mac. However, we may fix this in the future if there is enough demand for it.
