bitd version 0.4.3 is now available for download at:
...
Use the correct base transaction fee of 0.0005 B1T for accepting transactions into mined blocks (since 0.4.0, it was incorrectly accepting 0.0001 B1T which was only meant to be relayed).
