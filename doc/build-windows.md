...
Bit GitHub repository](https://github.com/bittoshimoto/Bit/)).
...
Note that for WSL v1 the Bit Core source path MUST be somewhere in the default mount file system, for
example /usr/src/bit, AND not under, for example, /mnt/d/bit. 
...
Ensure that this toolchain can build for `posix` (else you may have compilation errors for Bit's dependencies):
