The following is a list of assets used in the bit source and their proper attribution.
...
### Assets Used
    ...
    src/qt/res/icons/bit.icns
    src/qt/res/icons/bit.ico,
    src/qt/res/icons/bit.png
