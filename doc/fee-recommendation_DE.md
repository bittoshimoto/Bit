Bit-Gebührenempfehlung
----------------------------

_zuletzt aktualisiert für 1.0.0_

Die Bit-Kette hat ein relativ niedrigen Blockintervall, 1 Megabyte Blockspace
und zielt darauf ab, den Leuten eine kostengünstige Möglichkeit für Transaktionen zu bieten. Daher ist Spam die größte
Bedrohung für die Bit-Kette als Ganzes. Bit verwendet eine Transaktionsgebühr
und einen Dust-Abschreckungseffekt, um On-Chain-Spam zu bekämpfen.

Bit Core implementiert eine Reihe von Standardeinstellungen in die Software, die die
...
parametrisiert werden sollten. Die empfohlenen Standardwerte, wie sie in der Bit Core-Wallet implementiert sind, sind:
