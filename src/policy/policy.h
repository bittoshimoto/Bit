 ...
 *
 *  Bit:    Increment mempool limits and accept RBF in steps of 0.0001 PEPE
...
/**
 * Bit: Default dust limit that is evaluated when considering whether a
...
/**
 * Bit: Default hard dust limit that is evaluated when considering whether
