...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Bit Core repository on GitHub"),
        tr("Services that claim to double your bits are always ponzi schemes")
    };
