    ...
    platformStyle(_platformStyle)
{
    ...
    // Bit: load fallback font in case Monospace is not available on the system
    QFontDatabase::addApplicationFont(":fonts/RobotoMono-Bold");
    QFont::insertSubstitution("Monospace", "RobotoMono");

    // Bit: Specify Monospace as new font.
    QFont newFont("Monospace", 10);

    // Bit: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    importPrivateKeyAction->setStatusTip(tr("Import a Bit private key"));
