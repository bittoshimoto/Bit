...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        test_bit_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # Bit: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_bit_wallet_minchange(rbf_node, dest_address):
