...
Bit Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/bittoshimoto/Bit/labels/help%20wanted)
* [Projects](https://github.com/bittoshimoto/Bit/projects)
* [Bitdev on reddit](https://www.reddit.com/r/bitdev/)

## Branch Strategy

Bit Core's default branch is intentionally a stable release, so that anyone
...
Bit Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Bit Core
releases will automatically benefit from these.

When refactoring Bit-specific code, please keep refactoring requests short,
...
The following applies to code changes to Bit Core, and is not to be
confused with overall Bit Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Bit Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Bit; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Bit
