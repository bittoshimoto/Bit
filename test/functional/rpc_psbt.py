...
class PSBTTest(BitTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 B1T
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 tos/vB and 0.1 B1T/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
