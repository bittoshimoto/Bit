...
class TxnMallTest(BitTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 B1T:
        ...
        # First: use raw transaction API to send 1240 B1T to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 B1T coin each
