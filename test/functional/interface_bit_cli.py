...
# The block reward of coinbaseoutput.nValue (50) B1T/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 B1T/block.
...
class TestBitCli(BitTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_specified_wallet_compiled():
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (B1T/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (B1T/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 B1T) to the default wallet.
